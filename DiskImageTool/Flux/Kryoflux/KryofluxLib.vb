    ...
    Namespace Kryoflux
        Module KryofluxLib
            ...
            Public Function ConvertFirstTrack(FilePath As String) As (Result As Boolean, FileName As String)
                ...
                Dim result = ConsoleProcessRunner.RunProcess(KryofluxSettings.AppPath, Builder.Arguments, captureOutput:=False, captureError:=False)
            ...
            Private Function GetSide0FileName(Filename As String) As String
