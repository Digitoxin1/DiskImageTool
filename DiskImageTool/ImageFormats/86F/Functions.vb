    ...
    Namespace D86F
        Module Functions
            ...
            Public Function GetBitRate(BitRate As UShort, IsMFM As Boolean) As BitRate
                ...
                Select Case BitRate
                    Case 250
                        Result = D86F.BitRate.BitRate250
                    Case 300
                        Result = D86F.BitRate.BitRate300
                    Case 500
                        Result = D86F.BitRate.BitRate500
                    Case 1000
                        Result = D86F.BitRate.BitRate1000
                    Case 2000
                        Result = D86F.BitRate.BitRate2000
                    Case Else
                        Result = D86F.BitRate.BitRate250
                End Select
            ...
            Public Function GetRPM(RPM As UShort) As RPM
                ...
                Select Case RPM
                    Case 300
                        Return D86F.RPM.RPM300
                    Case 360
                        Return D86F.RPM.RPM360
                    Case Else
                        Return D86F.RPM.RPM300
                End Select
            End Function
